...
highlight Title        cterm=bold            guibg=none           gui=bold           ctermfg=234        guifg=#202020
highlight Underlined   cterm=underline       guibg=none           gui=underline      ctermfg=234        guifg=#202020
...
" Syntax
highlight Type         cterm=bold            guibg=none           gui=bold           ctermfg=28         guifg=#009933
highlight Define       cterm=bold            guibg=none           gui=bold           ctermfg=25         guifg=#1060a0
highlight Comment      cterm=none            guibg=none           gui=none           ctermfg=33         guifg=#1e90ff
highlight Constant     cterm=none            guibg=none           gui=none           ctermfg=137        guifg=#a07040
highlight String       cterm=none            guibg=none           gui=none           ctermfg=137        guifg=#a07040
highlight Number       cterm=none            guibg=none           gui=none           ctermfg=160        guifg=#cd0000
highlight Statement    cterm=bold            guibg=none           gui=bold           ctermfg=204        guifg=#fc548f

" Others
highlight PreProc      cterm=none            guibg=none           gui=none           ctermfg=25         guifg=#1060a0
highlight Error        ctermbg=231           cterm=bold,underline guibg=#ffffff      gui=bold,underline ctermfg=196   guifg=#ff0000
highlight Todo         cterm=bold,underline  guibg=none           gui=bold,underline ctermfg=103        guifg=#a0b0c0
highlight Special      cterm=none            guibg=none           gui=none           ctermfg=90         guifg=#8b038d
