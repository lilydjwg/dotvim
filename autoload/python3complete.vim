...
function! python3complete#Complete(findstart, base)
    ...
    "findstart = 0 when we need to return the list of completions
        ...
        endwhile
        execute "python3 vimcomplete('" . cword . "', '" . a:base . "')"
...
class Scope(object):
    ...
    def pop(self,indent):
        ...
        outer = self
        while outer.parent is not None and outer.indent >= indent:
            outer = outer.parent
        return outer
...
class PyParser:
    ...
    def next(self):
        type, token, (lineno, indent), end, self.parserline = self.gen.__next__()
